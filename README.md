...
## About
This isn't a normal static portfolio page — it's designed like a small browser experience. Visitors explore an interactive space, solve simple web-development puzzles, unlock sections, and discover different parts of the portfolio (About, Projects, Contact) along the way.
...
## Features
- Puzzle-based navigation instead of standard menus
- Interactive elements to unlock portfolio sections
