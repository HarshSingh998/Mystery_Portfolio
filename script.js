document.addEventListener('DOMContentLoaded', () => {
    ...
    const gameData = {
        // Puzzle 1: Emoji
        1: { answer: "html", question: "Which language gives structure to a web page?" },
        // Puzzle 2: HTML Riddle
        2: { answer: "css", question: "Which language styles a web page with colors, layout, fonts, and animations?" },
        // Puzzle 3: JS Coding Concept (Closures/Currying)
        3: { answer: "javascript", question: "Which language adds interactivity and logic to websites?" }
    };
